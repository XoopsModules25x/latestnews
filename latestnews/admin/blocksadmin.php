 ...
 * @since           1.0.6
 * @version         $Id: blocksadmin.php 12106 2013-09-29 10:23:10Z beckmi $
 */
...
//        mpu_adm_menu();
        ...
        echo '<a href="blocksadmin.php">' . _AM_BADMIN
            . '</a>&nbsp;<span style="font-weight:bold;">&raquo;&raquo;</span>&nbsp;' . _AM_SYSTEM_BLOCKS_CLONEBLOCK
            . '<br /><br />';
...
//        'name'       => $myblock->getVar('name'),
        ...
        echo '<a href="blocksadmin.php">' . _AM_BADMIN
            . '</a>&nbsp;<span style="font-weight:bold;">&raquo;&raquo;</span>&nbsp;' . _AM_SYSTEM_BLOCKS_EDITBLOCK
            . '<br /><br />';
        include 'blockform.php';
        $form->display();
//        xoops_cp_footer();
